...
((SELECT id FROM person WHERE email = 'john.doe@example.com'), 'Tech Innovations Inc.', 'Senior Software Engineer', 'Software Developer', '2018-05-01', NULL, 1),
((SELECT id FROM person WHERE email = 'jane.smith@example.com'), 'Global Marketing Group', 'Marketing Manager', 'Marketing Professional', '2019-03-15', NULL, 1),
